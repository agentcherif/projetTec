...
<html lang="fr">
  ...
  <img id="icon" src="../images/logo5.png" >
    ...
    <br />
     <form method="POST" action="addSujet.php?categorie=<?=$_GET['categorie']?>" >
     	  <div class="row">
     	  	<div class="col-md-4"></div>
     	  	<div class="col-md-4">
     	  		<input name="name" type="text" class="form-control " id="name" placeholder="Nom du sujet..." required><br>
                <textarea name="sujet" class="form-control" placeholder="Contenue du sujet..."></textarea><br>
                <input type="hidden" name="categorie" value="<?= $_GET['categorie']?>">
     	  	    	<div class="form-actions" id="val">
                  <input class="btn btn-outline-info " type="submit" value="Ajouter le Sujet">
                </div><br />
                <?php 
                if(isset($erreur))
